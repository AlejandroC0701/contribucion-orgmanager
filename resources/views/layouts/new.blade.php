...
<body class="bg-grey-lightest bg-pattern font-sans border-t-2 border-brand @yield('body-classes')">
    <div class="fixed pin-x pin-t w-screen border-t-2 border-brand z-50"></div>
    <div id="app">
        <nav class="w-screen h-12 fixed">
            <div class="bg-white border-t border-transparent">
                <div class="my-4 mx-auto">
                    <div class="flex border-b bg-white separador-nav">
                        ...
                        <div class="w-1/2 flex justify-center">
                            <a href="{{ route('dashboard') }}" class="no-underline text-inherit mt-1 border-b-2 {{ Route::is('dashboard') ? 'border-brand hover:border-purple':'border-transparent hover:border-purple' }}"><b>Dashboard</b></a>
                        </div>
                        <div class="w-1/4 text-right flex justify-center">
                            <a href="{{ route('logout') }}" class="no-underline mt-1 flex justify-center" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
