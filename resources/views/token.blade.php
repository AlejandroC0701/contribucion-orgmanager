    ...
    <div>
        <div class="max-w-lg rounded overflow-hidden shadow-lg">
                <div class="px-6 py-4">
                    ...
                    <input class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4 mb-3 text-center" id="token" value="adijfiejoin21312i|js" readonly>
                </div>
