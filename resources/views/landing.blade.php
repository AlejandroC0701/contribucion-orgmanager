...
<body class="">
    <div class="absolute pin flex justify-center items-center text-center bg-grey-lightest -mb-24 border-t-2 border-brand">
        <div>
            ...
            <p class="text-black-light font-sans leading-normal text-xl mb-8">{{ config('app.name') }} allows Github Organizations to share invite links for free!</p>
        ...
        <footer class="absolute pin-x pin-b bg-white border-t border-dark-light h-24 flex items-center justify-around">
            <div>
