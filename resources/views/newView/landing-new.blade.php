...
<body class="">
    <div class="absolute pin flex justify-center items-center text-center bg-grey-lightest -mb-24 border-t-2 border-brand bg-pattern">
        <div style="background-color: white; 
            ...
            <p class="text-black-darker font-sans leading-normal text-xl mb-8">{{ config('app.name') }} allows Github Organizations to share invite links for free!</p>
            <div class="flex items-center justify-around">
                    ...
                    <a href="https://github.com/Joseeli54/orgmanager" target="_blank" rel="noopener noreferrer" class="no-underline bg-black-light border-2 border-black-light hover:bg-white text-white hover:text-black-light font-bold py-3 px-6 self-stretch rounded-full">
            ...
            <div class="mt-8 flex items-center justify-around">
                ...
                <p class="text-black-darker text-base">Latest Release: v2.0 (Feb 19, 2017)</p>
                <div class="w-32 border-b border-black-dark"></div>
            </div>
            <div class="mt-8 flex items-center justify-around text-center">
                <div>
                    ...
                    <p class="text-black-darker">Multi-user support</p>
                </div>
                <div>
                    <div class="rounded-full m-2">
                    ...
                    <p class="text-black-darker">Share invite links</p>
                </div>
                <div>
                    <div class="rounded-full m-2">
                    ...
                    <p class="text-black-darker">Control your team!</p>
                </div>
            </div>
        </div>
    </div>
    <footer class="absolute pin-x pin-b bg-white border-t border-dark-light h-24 flex items-center justify-around" style="height: 3rem">
            <div class="text-center" style="margin-left: 15%">
                <p class="text-black-darker"> <b> <Used by <span class="text-grey-darkest">{{ \App\User::count() }} users &amp; {{ \App\Org::count() }} orgs</span>, we have delivered <span class="text-grey-darkest">{{ \App\Org::sum('invitecount') }}</span> invites </b></p>
            </div>
            <div>
                <a class="text-black-light no-underline" href="https://github.com/Joseeli54/orgmanager" target="_blank" rel="noopener noreferrer">
                    <svg class="w-6 h-6" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12 .3C5.4.3 0 5.7 0 12.3c0 5.3 3.4 9.8 8.2 11.4.6 0 .8-.3.8-.6v-2c-3.3.8-4-1.5-4-1.5-.6-1.4-1.4-1.8-1.4-1.8-1-.7 0-.7 0-.7 1.3 0 2 1.2 2 1.2 1 1.8 2.8 1.3 3.5 1 .2-.8.5-1.3.8-1.6-2.7-.3-5.5-1.3-5.5-6 0-1.2.5-2.3 1.3-3-.2-.5-.6-1.7 0-3.3 0 0 1-.3 3.4 1.2 1-.3 2-.4 3-.4s2 .2 3 .5c2.3-1.5 3.3-1.2 3.3-1.2.6 1.6.2 2.8 0 3.2 1 .8 1.3 2 1.3 3.2 0 4.6-2.8 5.6-5.5 6 .6.3 1 1 1 2v3.4c0 .4 0 .8.8.7 4.8-1.6 8.2-6 8.2-11.4 0-6.6-5.4-12-12-12"/>
                    </svg>
                </a>
