...
@section('content')
    <div>
        <div class="flex items-center justify-center " style="background-color: #626262; padding: 20px; margin-top: 10%; margin-bottom: -10%;
            border-radius:.25rem;">
            <svg class="h-16 w-16 text-black-dark" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" > 
                ...
                <div> <h1 class="text-white" style="margin-left: 10%;"> Search </h1> </div>
            </svg>
        </div>
        <div class="mt-15" style="background-color: #fff; padding: 20px; border-radius:.25rem;" >
            <p class="text-black-ligh  text-2xl m-4 text-center">Looks like there's nothing here</p>
            ...
            <p class="text-base text-black-darker text-center">If your  organizations aren't showing here after sync, check <a class="no-underline text-inherit link-transition" style="color:blue" href="https://github.com/settings/connections/applications/{{ config('services.github.client_id') }}" target="_blank" rel="noopener noreferrer">we’ve been given access to them</a>.</p>
        </div>
