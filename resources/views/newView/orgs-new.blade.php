...
@section('content')
    <div>
        ...
        <div class="text-center" style="margin-bottom: 10px; margin-top: 5%">
                    <p class="text-white text-2xl">Your organizations</p>
            </div>
        <table class="flex items-center justify-center" style="border-spacing: 1rem;
        margin-bottom: 2%">
                <tbody>
                    
                    <tr class="bg-white rounded flex justify-around mb-4" style="margin-bottom: 0px; padding: 10px">
                        <td class="flex items-center text-center">
                            <img src="/img/orgmanagerIcon.png" alt="Manuel" class="w-10 h-10">
                        </td>
                        <td class="flex items-center text-center">
                            <p class="text-base text-black-light w-64"> <b> Manuel  C.A. </b></p>
                        </td>
                        <td class="flex items-center justify-center">
                            <p class="text-base text-black mr-3"> <b> Invite Link </b></p>
                            <a class="text-base text-brand-darker mr-6" href="" target="_blank" rel="noopener noreferrer"> <b> Unity </b></a>
        ...
        <div class="w-screen flex items-center justify-around mb-8">
            <form action="{{ route('sync') }}" method="POST">
                {{ csrf_field() }}
                <button type="submit" class="bg-brand hover:bg-grey-dark text-white font-bold py-3 px-4 rounded-full focus:outline-none">
                    <div class="inline-block">
                        <div class="flex items-center justify-center">
                            <svg class="w-4 h-4 mr-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
